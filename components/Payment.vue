...
export default {
  ...
  mounted() {
    ...
    // alert(this.dataPackage)
    // this.tappayData.cardholder.phone_number =
    //   this.GET_APIDATA.register.phoneCode + this.GET_APIDATA.register.phoneNumber
    // })
    //initial tappayData
    ...
    TPDirect.setupSDK(
      16984,
      'app_n3M0mgwsk8RbkwrP5AjhiKhOeE8Dsnd2QwTcAZsSTxBKWvs5g0J72hSD8Tt3',
      'sandbox'
    )
  ...
  methods: {
    ...
    setFields() {
      const json = JSON.parse(this.GET_APIDATA)
